...
// =================== HANDLE INVOICE VIEW BASED ON URL ===================
if (isset($_GET['invoice_number'])) {
    // Sanitize user input (the invoice number from the URL)
    $invoice_number = safe($conn, $_GET['invoice_number']);
    ...
    // If no invoice number is passed through URL
    echo "<h3>Invoice number not provided in the URL.</h3>";
}
